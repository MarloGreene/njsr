...
const toolDescriptions = {
  ...
  'mp': 'Markdown Preview - Minimalist two-pane markdown editor with real-time preview',
  'one': 'Ministering Memory Helper - LDS ministering assignment tracker',
  'penguin': 'Penguin Peak - Endless 3D penguin climbing game with parallax mountains',
  ...
  'rw': 'RunWritr - Writing environment with animated ASCII running companion',
